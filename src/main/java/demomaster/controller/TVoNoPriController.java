...
@RestController
@RequestMapping(value = "/TVoNoPriController")
@Slf4j
public class TVoNoPriController {

    @Autowired
    private TVoNoPriService service;
    ...
    public Response insert(@RequestBody TVoNoPriVo vo) {
    ...
    public Response insert(@RequestBody List<TVoNoPriVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TVoNoPriVo query) {
        Response response = new Response();
        try {
            List<TVoNoPriVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TVoNoPriVo query,
    ...
    public Response queryMultiTermPageHelper(@RequestBody TVoNoPriMultiTermVo query,
                                             @RequestParam(value = "pageNum", defaultValue = "1", required = false) Integer pageNum,
                                             @RequestParam(value = "pageSize", defaultValue = "10", required = false) Integer pageSize,
                                             @RequestParam(value = "order", required = false) String order) {
         Response response = new Response();
         try {
             ...
             List<TVoNoPriVo> result = service.queryMultiTerm(query);
             PageInfo pageInfo = new PageInfo(result);
             response.setCode(Code.System.OK);
             response.setContent(pageInfo);
             log.info("success pageInfo -> {} ", pageInfo);
    ...
    public Response updateBase(@RequestBody RequestUpdate<TVoNoPriVo,TVoNoPriVo> update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody RequestUpdate<TVoNoPriVo,TVoNoPriVo> update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TVoNoPriVo vo) {
        Response response = new Response();
        try {
    ...
    public Response updateByPrimaryKey(@RequestBody RequestUpdate<TVoNoPriNoPriVo,TVoNoPriPriVo> update) {
        Response response = new Response();
        try {
