...
@RestController
@RequestMapping(value = "/TFieldController")
@Slf4j
public class TFieldController {

    @Autowired
    private TFieldService service;
    ...
    public Response insert(@RequestBody TFieldVo vo) {
    ...
    public Response insert(@RequestBody List<TFieldVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TFieldVo query) {
        Response response = new Response();
        try {
            List<TFieldVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TFieldVo query,
    ...
    public Response queryMultiTermPageHelper(@RequestBody TFieldMultiTermVo query,
                                             @RequestParam(value = "pageNum", defaultValue = "1", required = false) Integer pageNum,
                                             @RequestParam(value = "pageSize", defaultValue = "10", required = false) Integer pageSize,
                                             @RequestParam(value = "order", required = false) String order) {
         Response response = new Response();
         try {
             ...
             List<TFieldVo> result = service.queryMultiTerm(query);
             PageInfo pageInfo = new PageInfo(result);
             response.setCode(Code.System.OK);
             response.setContent(pageInfo);
             log.info("success pageInfo -> {} ", pageInfo);
    ...
    public Response updateBase(@RequestBody RequestUpdate<TFieldVo,TFieldVo> update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody RequestUpdate<TFieldVo,TFieldVo> update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TFieldVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(
        ...
        Response response = new Response();
        try {
            TFieldVo result = service.queryByPrimaryKey(dbName, dbTableName, fieldName);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response deleteByPrimaryKey(
        ...
        Response response = new Response();
        try {
            Boolean result = service.deleteByPrimaryKey(dbName, dbTableName, fieldName);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody RequestUpdate<TFieldNoPriVo,TFieldPriVo> update) {
        Response response = new Response();
        try {
