...
@RestController
@RequestMapping(value = "/TVoController")
@Slf4j
public class TVoController {

    @Autowired
    private TVoService service;
    ...
    public Response insert(@RequestBody TVoVo vo) {
    ...
    public Response insert(@RequestBody List<TVoVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TVoVo query) {
        Response response = new Response();
        try {
            List<TVoVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TVoVo query,
    ...
    public Response queryMultiTermPageHelper(@RequestBody TVoMultiTermVo query,
                                             @RequestParam(value = "pageNum", defaultValue = "1", required = false) Integer pageNum,
                                             @RequestParam(value = "pageSize", defaultValue = "10", required = false) Integer pageSize,
                                             @RequestParam(value = "order", required = false) String order) {
         Response response = new Response();
         try {
             ...
             List<TVoVo> result = service.queryMultiTerm(query);
             PageInfo pageInfo = new PageInfo(result);
             response.setCode(Code.System.OK);
             response.setContent(pageInfo);
             log.info("success pageInfo -> {} ", pageInfo);
    ...
    public Response updateBase(@RequestBody RequestUpdate<TVoVo,TVoVo> update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody RequestUpdate<TVoVo,TVoVo> update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TVoVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(
        ...
        Response response = new Response();
        try {
            TVoVo result = service.queryByPrimaryKey(dbName, dbTableName);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody RequestUpdate<TVoNoPriVo,TVoPriVo> update) {
        Response response = new Response();
        try {
