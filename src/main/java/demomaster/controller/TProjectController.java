...
@RestController
@RequestMapping(value = "/TProjectController")
@Slf4j
public class TProjectController {

    @Autowired
    private TProjectService service;
    ...
    public Response insert(@RequestBody TProjectVo vo) {
    ...
    public Response insert(@RequestBody List<TProjectVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TProjectVo query) {
        Response response = new Response();
        try {
            List<TProjectVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TProjectVo query,
    ...
    public Response queryMultiTermPageHelper(@RequestBody TProjectMultiTermVo query,
                                             @RequestParam(value = "pageNum", defaultValue = "1", required = false) Integer pageNum,
                                             @RequestParam(value = "pageSize", defaultValue = "10", required = false) Integer pageSize,
                                             @RequestParam(value = "order", required = false) String order) {
         Response response = new Response();
         try {
             ...
             List<TProjectVo> result = service.queryMultiTerm(query);
             PageInfo pageInfo = new PageInfo(result);
             response.setCode(Code.System.OK);
             response.setContent(pageInfo);
             log.info("success pageInfo -> {} ", pageInfo);
    ...
    public Response updateBase(@RequestBody RequestUpdate<TProjectVo,TProjectVo> update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody RequestUpdate<TProjectVo,TProjectVo> update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TProjectVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(
        ...
        Response response = new Response();
        try {
            TProjectVo result = service.queryByPrimaryKey(dbName);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody RequestUpdate<TProjectNoPriVo,TProjectPriVo> update) {
        Response response = new Response();
        try {
