...
@RestController
@RequestMapping(value = "/TMapperController")
@Slf4j
public class TMapperController {

    @Autowired
    private TMapperService service;
    ...
    public Response insert(@RequestBody TMapperVo vo) {
    ...
    public Response insert(@RequestBody List<TMapperVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TMapperVo query) {
        Response response = new Response();
        try {
            List<TMapperVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TMapperVo query,
    ...
    public Response queryMultiTermPageHelper(@RequestBody TMapperMultiTermVo query,
                                             @RequestParam(value = "pageNum", defaultValue = "1", required = false) Integer pageNum,
                                             @RequestParam(value = "pageSize", defaultValue = "10", required = false) Integer pageSize,
                                             @RequestParam(value = "order", required = false) String order) {
         Response response = new Response();
         try {
             ...
             List<TMapperVo> result = service.queryMultiTerm(query);
             PageInfo pageInfo = new PageInfo(result);
             response.setCode(Code.System.OK);
             response.setContent(pageInfo);
             log.info("success pageInfo -> {} ", pageInfo);
    ...
    public Response updateBase(@RequestBody RequestUpdate<TMapperVo,TMapperVo> update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody RequestUpdate<TMapperVo,TMapperVo> update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TMapperVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(
        ...
        Response response = new Response();
        try {
            TMapperVo result = service.queryByPrimaryKey(dbName, dbTableName);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody RequestUpdate<TMapperNoPriVo,TMapperPriVo> update) {
        Response response = new Response();
        try {
