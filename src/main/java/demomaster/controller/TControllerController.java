...
@RestController
@RequestMapping(value = "/TControllerController")
@Slf4j
public class TControllerController {

    @Autowired
    private TControllerService service;
    ...
    public Response insert(@RequestBody TControllerVo vo) {
    ...
    public Response insert(@RequestBody List<TControllerVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TControllerVo query) {
        Response response = new Response();
        try {
            List<TControllerVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response queryBasePageHelper(@RequestBody TControllerVo query,
    ...
    public Response queryMultiTermPageHelper(@RequestBody TControllerMultiTermVo query,
                                             @RequestParam(value = "pageNum", defaultValue = "1", required = false) Integer pageNum,
                                             @RequestParam(value = "pageSize", defaultValue = "10", required = false) Integer pageSize,
                                             @RequestParam(value = "order", required = false) String order) {
         Response response = new Response();
         try {
             ...
             List<TControllerVo> result = service.queryMultiTerm(query);
             PageInfo pageInfo = new PageInfo(result);
             response.setCode(Code.System.OK);
             response.setContent(pageInfo);
             log.info("success pageInfo -> {} ", pageInfo);
    ...
    public Response updateBase(@RequestBody RequestUpdate<TControllerVo,TControllerVo> update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody RequestUpdate<TControllerVo,TControllerVo> update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TControllerVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(
        ...
        Response response = new Response();
        try {
            TControllerVo result = service.queryByPrimaryKey(dbName, dbTableName);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody RequestUpdate<TControllerNoPriVo,TControllerPriVo> update) {
        Response response = new Response();
        try {
