 ...
 */
@Data
public class MapperFtl implements FtlJavaInterface {
    private String packageName;//包名
    private String dir = "mapper";//文件夹名称
    private String className;//class名称
    private String fileName;//file名称
    private String freeMarkFtlPath = "Mapper.ftl";//生成FreeMark的ftlPath
     ...
     * 以下是独有的
     */
    List<MysqlAndJavaField> primaryKeyMysqlAndJavaFields;

    List<MysqlAndJavaField> mysqlAndJavaFields;
