 ...
 */
@Data
public class ControllerFtl implements FtlJavaInterface {
    private String packageName;//包名
    private String dir = "controller";//文件夹名称
    private String className;//class名称
    private String fileName;//file名称
    private String freeMarkFtlPath = "Controller.ftl";//生成FreeMark的ftlPath
