 ...
 */
@Data
public class ServiceImplFtl implements FtlJavaInterface {
    private String packageName;//包名
    private String dir = "serviceImpl";//文件夹名称
    private String className;//class名称
    private String fileName;//file名称
    private String freeMarkFtlPath = "ServiceImpl.ftl";//生成FreeMark的ftlPath
