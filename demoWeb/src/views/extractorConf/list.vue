  ...
  <div class="app-container">
    <div class="mt20">
      <el-form :inline="true" size="mini">
        ...
        <el-form-item>
          <el-button type="primary" class="el-button-search" @click="insertExtractorConfByRegistId">添加</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="app-list">
        ...
        <table>
          ...
          <tr v-for="(info,index) in dataList">
            ...
            <td>
              ...
              <span @click="routerToExtractorConfEdit(info.id)">编辑</span>
              <span @click="deleteExtractorConfById(info.id)">删除</span>
            </td>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      self.getExtractorConfsByRegistId(registId)
    },
    watch: {
      timeRange: {
    ...
    methods: {
      ...
      insertExtractorConfByRegistId() {
        let self = this;
        const registId = this.$route.query && this.$route.query.registId;
        self.getExtractorConfsByRegistId(registId)
        self.$http.get(self.api.insertExtractorConfByRegistId, {
          params: {
            registId: registId
          }
        }, function (response) {
      ...
      getExtractorConfsByRegistId(registId) {
        let self = this;
        self.$http.get(self.api.getExtractorConfsByRegistId, {
          params: {
            registId: registId
          }
        }, function (response) {
      ...
      routerToExtractorConfEdit(id) {
        //跳转携带参数
        window.open("#/extractorConfEdit" + "?id=" + id, '_self');
        // this.$router.push({name: 'extractorConfEdit', params: {id: id}});
      },
      copyRecord(id) {
        let self = this;
        self.$http.get(self.api.copyRecord, {
          ...
          if (response.content == true) {
            ...
            self.getExtractorConfsByRegistId(self.registId)
          } else {
            self.$message({
              type: 'warning',
      ...
      deleteExtractorConfById(id) {
        ...
        this.$confirm('是否删除该条数据？', '提示', {
          ...
          self.$http.get(self.api.deleteExtractorConfById, {
            params: {
              id: id
            }
          }, function (response) {
